    ...
    e.fn.fullpage = function(a) {
        ...
        function ye(e, n) {
            if (lt.m[e]) {
                ...
                if (jn.scrollHorizontally && (o = jn.scrollHorizontally.getScrollSection(e, o)), n.length > 0) {
                    if (!a.scrollOverflowHandler.isScrolled(t, n)) return !0;
                    o()
                } else o()
            }
        }
        ...
        function pn(e) {
            if (!e.hasClass("fp-noscroll")) {
                ...
                var n, t = a.scrollOverflowHandler,
                    o = t.wrapContent(),
                    i = e.closest(y),
                    l = t.scrollable(e);
        ...
        function xn(e, n) {
            ...
            t.find("li:nth-child(1) a").append('<i class="fa fa-bank" aria-hidden="true"></i>');
            t.find("li:nth-child(2) a").append('<i class="fa fa-users" aria-hidden="true"></i>');
            t.find("li:nth-child(3) a").append('<i class="fa fa-cog" aria-hidden="true"></i>');
            t.find("li:nth-child(4) a").append('<i class="fa fa-envelope" aria-hidden="true"></i>');
        ...
        function Tn(e) {
            ...
            else if (Jn || Zn) n.history.replaceState(i, i, "#" + e);
            else {
        ...
        function Ln() {
            ...
            for (var r in l) o.style[r] !== i && (o.style[r] = "translate3d(1px,1px,1px)", e = n.getComputedStyle(o).getPropertyValue(l[r]));
        ...
        if (e("html").hasClass(u)) return void qn();
        var Nn = e("html, body"),
            Xn = e("body"),
            jn = e.fn.fullpage;
        a = e.extend({
        ...
        var rt, at, st, ct, dt, ft, ut = e.extend(!0, {}, a);
